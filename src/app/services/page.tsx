  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#0A0E1A] text-white">
      ...
      <nav className="sticky top-4 z-50 flex justify-center px-4 sm:px-6 relative">
        <div className={`flex items-center justify-between w-full max-w-3xl px-4 sm:px-6 py-3 rounded-full border border-white/10 transition-all duration-300 ${scrolled ? "bg-[#0A0E1A]/90 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.4)]" : "bg-[#0D1120]/80 backdrop-blur-sm"}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="relative flex flex-col rounded-2xl border border-white/10 bg-gradient-to-b from-[#7C3AED]/20 to-[#0D1120] backdrop-blur-sm overflow-hidden shadow-[0_0_40px_rgba(124,58,237,0.15)] transition-all duration-300 hover:border-white/20 h-full">
              ...
              <div className="p-6 flex flex-col h-full relative z-10">
                ...
                <div className="mt-auto">
                  <a href="/contact?service=Cybersecurity/VAPT&budget=Under $500" className="block w-full text-center rounded-xl border border-white/10 py-3 text-sm font-semibold text-white transition hover:border-[#7C3AED]/50 hover:bg-[#7C3AED]/10">Get Started</a>
                </div>
              </div>
            </div>
            </FadeUp>
            ...
            <div className="relative flex flex-col rounded-2xl border border-[#7C3AED]/50 bg-gradient-to-b from-[#7C3AED]/20 to-[#0D1120] backdrop-blur-sm overflow-hidden shadow-[0_0_50px_rgba(124,58,237,0.25)] transition-all duration-300 hover:shadow-[0_0_50px_rgba(124,58,237,0.35)] h-full">
              ...
              <div className="p-6 flex flex-col h-full relative z-10 mt-1">
                ...
                <div className="mt-auto">
                  <a href="/contact?service=Cybersecurity/VAPT&budget=Under $500" className="block w-full text-center rounded-xl bg-[#7C3AED] py-3 text-sm font-semibold text-white shadow-[0_0_15px_rgba(124,58,237,0.35)] transition hover:bg-[#6D28D9]">Get Started</a>
                </div>
              </div>
            </div>
            </FadeUp>
            ...
            <div className="relative flex flex-col rounded-2xl border border-white/10 bg-gradient-to-b from-[#7C3AED]/20 to-[#0D1120] backdrop-blur-sm overflow-hidden shadow-[0_0_40px_rgba(124,58,237,0.15)] transition-all duration-300 hover:border-white/20 h-full">
              ...
              <div className="p-6 flex flex-col h-full relative z-10">
                ...
                <div className="mt-auto">
                  <a href="/contact?service=Cybersecurity/VAPT&budget=$5000+" className="block w-full text-center rounded-xl border border-white/10 py-3 text-sm font-semibold text-white transition hover:border-[#7C3AED]/50 hover:bg-[#7C3AED]/10">Contact Us</a>
                </div>
              </div>
            </div>
            </FadeUp>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="relative flex flex-col rounded-2xl border border-white/10 bg-gradient-to-b from-[#7C3AED]/20 to-[#0D1120] backdrop-blur-sm overflow-hidden shadow-[0_0_40px_rgba(124,58,237,0.15)] transition-all duration-300 hover:border-white/20 h-full">
              ...
              <div className="p-6 flex flex-col h-full relative z-10">
                ...
                <div className="mt-auto">
                  <a href="/contact?service=Web Development&budget=Under $500" className="block w-full text-center rounded-xl border border-white/10 py-3 text-sm font-semibold text-white transition hover:border-[#7C3AED]/50 hover:bg-[#7C3AED]/10">Get Started</a>
                </div>
              </div>
            </div>
            </FadeUp>
            ...
            <div className="relative flex flex-col rounded-2xl border border-[#7C3AED]/50 bg-gradient-to-b from-[#7C3AED]/20 to-[#0D1120] backdrop-blur-sm overflow-hidden shadow-[0_0_50px_rgba(124,58,237,0.25)] transition-all duration-300 hover:shadow-[0_0_50px_rgba(124,58,237,0.35)] h-full">
              ...
              <div className="p-6 flex flex-col h-full relative z-10 mt-1">
                ...
                <div className="mt-auto">
                  <a href="/contact?service=Web Development&budget=Under $500" className="block w-full text-center rounded-xl bg-[#7C3AED] py-3 text-sm font-semibold text-white shadow-[0_0_15px_rgba(124,58,237,0.35)] transition hover:bg-[#6D28D9]">Get Started</a>
                </div>
              </div>
            </div>
            </FadeUp>
            ...
            <div className="relative flex flex-col rounded-2xl border border-white/10 bg-gradient-to-b from-[#7C3AED]/20 to-[#0D1120] backdrop-blur-sm overflow-hidden shadow-[0_0_40px_rgba(124,58,237,0.15)] transition-all duration-300 hover:border-white/20 h-full">
              ...
              <div className="p-6 flex flex-col h-full relative z-10">
                ...
                <div className="mt-auto">
                  <a href="/contact?service=Web Development&budget=$500-$1500" className="block w-full text-center rounded-xl border border-white/10 py-3 text-sm font-semibold text-white transition hover:border-[#7C3AED]/50 hover:bg-[#7C3AED]/10">Contact Us</a>
                </div>
              </div>
            </div>
            </FadeUp>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="relative flex flex-col rounded-2xl border border-white/10 bg-gradient-to-b from-[#7C3AED]/20 to-[#0D1120] backdrop-blur-sm overflow-hidden shadow-[0_0_40px_rgba(124,58,237,0.15)] transition-all duration-300 hover:border-white/20 h-full">
              ...
              <div className="p-6 flex flex-col h-full relative z-10">
                ...
                <div className="mt-auto">
                  <a href="/contact?service=Video Production&budget=Under $500" className="block w-full text-center rounded-xl border border-white/10 py-3 text-sm font-semibold text-white transition hover:border-[#7C3AED]/50 hover:bg-[#7C3AED]/10">Get Started</a>
                </div>
              </div>
            </div>
            </FadeUp>
            ...
            <div className="relative flex flex-col rounded-2xl border border-[#7C3AED]/50 bg-gradient-to-b from-[#7C3AED]/20 to-[#0D1120] backdrop-blur-sm overflow-hidden shadow-[0_0_50px_rgba(124,58,237,0.25)] transition-all duration-300 hover:shadow-[0_0_50px_rgba(124,58,237,0.35)] h-full">
              ...
              <div className="p-6 flex flex-col h-full relative z-10 mt-1">
                ...
                <div className="mt-auto">
                  <a href="/contact?service=Video Production&budget=Under $500" className="block w-full text-center rounded-xl bg-[#7C3AED] py-3 text-sm font-semibold text-white shadow-[0_0_15px_rgba(124,58,237,0.35)] transition hover:bg-[#6D28D9]">Get Started</a>
                </div>
              </div>
            </div>
            </FadeUp>
            ...
            <div className="relative flex flex-col rounded-2xl border border-white/10 bg-gradient-to-b from-[#7C3AED]/20 to-[#0D1120] backdrop-blur-sm overflow-hidden shadow-[0_0_40px_rgba(124,58,237,0.15)] transition-all duration-300 hover:border-white/20 h-full">
              ...
              <div className="p-6 flex flex-col h-full relative z-10">
                ...
                <div className="mt-auto">
                  <a href="/contact?service=Video Production&budget=Under $500" className="block w-full text-center rounded-xl border border-white/10 py-3 text-sm font-semibold text-white transition hover:border-[#7C3AED]/50 hover:bg-[#7C3AED]/10">Contact Us</a>
                </div>
              </div>
            </div>
            </FadeUp>
      ...
      <section className="relative px-4 sm:px-6 py-24 border-t border-white/5 bg-white/[0.01]">
        ...
        <div className="mx-auto max-w-4xl text-center space-y-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-2">
            ...
            <a href="/contact" className="rounded-xl border border-white/15 px-8 py-4 font-semibold text-white transition hover:border-[#7C3AED]/60 hover:bg-white/5">Send a Message</a>
          </div>
        </div>
      </section>
